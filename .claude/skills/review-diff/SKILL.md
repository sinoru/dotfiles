...
5. Launch 5 parallel agents to review the changes independently:
   ...
   - **Agent 5 — Security**: Review for security vulnerabilities from an attacker's perspective.
     Three-phase analysis:
     (1) Context Research — Use Glob/Grep to identify existing security frameworks, validation patterns, auth middleware, etc.
     (2) Comparative Analysis — Compare whether changed code follows existing security patterns or introduces new attack surfaces
